...
- [Solving Linear Systems in O(1): The 2X, Matrix Inversion, and Gitter Methods](Bachelor_Thesis/O(1)-Methods) [![DOI][![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.15838111.svg)](https://doi.org/10.5281/zenodo.15838111)
